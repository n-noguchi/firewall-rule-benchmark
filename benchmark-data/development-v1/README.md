# Firewall benchmark dataset: development-v1
...
This profile has 24 tenant policies, 2 largest tenants, and 60 rules in each largest tenant. The development profile is intentionally small enough to review and execute in CI, while exercising the same semantics.
